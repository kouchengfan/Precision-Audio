<?php
	...
	$sqlnews = "SELECT * FROM  `news` ORDER BY  `new_ID` DESC  LIMIT $start_from, ".$results_per_page;
							...
							<div class="col-md-3 col-sm-4 ">							
								<div class="single-product">
									...
									<div class="product-f-image">
											<img style="height: 375px;" src="news/<?php echo $row['new_File']?>.jpg" alt="">
										...
										<h2 style="font-size:15px; display: block; width: 250px; overflow: hidden; white-space: nowrap; text-overflow: ellipsis; "><a href="news/<?php echo $row['new_File']?>.pdf"><?php echo $row['new_Name']?></a></h2>
                    ...
                    <div class="product-pagination text-center">
                        <nav>
                          <ul class="pagination">
							...
							<?php 
							$sql = "SELECT COUNT(new_ID) AS total FROM `news`";
							...
							?>							
                            <li>
                              <a href="news.php?page=<?php echo ($page-1) ?>" aria-label="Previous">
                            ...
                            <li>
                              <a href="news.php?page=<?php echo ($page+1) ?>" aria-label="Next">
